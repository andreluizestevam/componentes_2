...
{
    /// <summary>
    /// Controle Customizado para o ListBox
    /// </summary>
    [ToolboxData("<{0}:TListBox runat=\"server\"></{0}:TListBox>")]
    public class TListBox : ListBox, IValidationControl, ILabelControl, IBindControl
    {
        #region Contrutores
